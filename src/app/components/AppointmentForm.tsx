  ...
  return (
    <section className="py-20 bg-gradient-to-b from-emerald-50/60 via-white to-white">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {/* Formulario */}
        <form className="bg-white p-8 rounded-2xl shadow-xl ring-1 ring-slate-100 space-y-5">
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Nombre completo</label>
            <input
              type="text"
              placeholder="Ingresa tu nombre"
              className="w-full border border-slate-300 p-3 rounded-lg focus:outline-none focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full md:w-auto bg-emerald-600 hover:bg-emerald-700 text-white font-medium px-6 py-3 rounded-lg transition"
          >
            Enviar solicitud
          </button>
        </form>
